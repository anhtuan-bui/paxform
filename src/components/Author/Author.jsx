...
export default function Author(props) {
  ...
  const authorNameString = author?.firstName || author?.lastName
  ...
  const authorName =authorNameString ? authorNameString : <Skeleton width={100}/>
    
  const authorTitle = author ? author?.roles?.nodes[0]?.displayName : <Skeleton width={75}/>;
  return (
