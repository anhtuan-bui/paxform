                ...
                <div className="related_card__top">
                    ...
                    }
                    {
                        this.props.description
                            ? <p className="related_card__description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour...</p>
                            : ''
                    }
                </div>
