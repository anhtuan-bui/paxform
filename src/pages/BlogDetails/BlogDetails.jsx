...
import Video from "../../assets/videos/rick.mp4"
            ...
            <div className="container hero" background="light">
                <div className="wrapper">
                    ...
                    <article className="article">
                        ...
                        <div className="quote rounded_20">
                        ...
                        <video className="company_video rounded_20" src={Video} poster={VideoPoster} controls />
                        <div className="article__snippet">
