                ...
                <section className="content">
                    <div className="container content__wrapper">
                            ...
                            <div className="dropdown-content">
                                {
                                    this.dropdown.map((option, index) => (
                                        <div className="list-item" key={index} >
                                            ...
                                            <a href={`#section${index}`} value={option} onClick={(e) => this.handleDropdownOptionClick(e)}>{option}</a>
                                        </div>
                                    ))
                                }
                            </div>
                        ...
                        <div className="section-heading">
                            <ul>
                                <li><a href="#section0">Section One</a></li>
                                <li><a href="#section1">Section Two</a></li>
                            </ul>
                        </div>
                        ...
                        <section className="article">
                            <div className="heading-zero">
                                ...
                                <p>Pa hospital. All my information and medical history were filled in an instance. Had I done it manually, I would have had to find all the details, which would have taken hours!</p>
                                <p>We may colltion Information from Users of our Products to help us provide, administer, and improve our Products. In order to use the Products, you will need to provide your full name and email address to us. To make changes to the permissions you give us, please visit your Bynder User profile.</p>
                            </div>
