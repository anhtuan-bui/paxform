                    ...
                    <div className="wrapper">
                                    ...
                                    <div className="dropdown-table">
                                        <ul>
                                            <li className="list-item">
                                                ...
                                                <a className="list-item-text" href={`#heading20`} name="heading20" >Changing the process</a>
                                            </li>
                                            <li className="list-item">
                                                <div className="blue-bar"></div>
                                                <a className="list-item-text" href={`#heading29`} name="heading29">Growing quickly</a>
                                            </li>
                                            <li className="list-item">
                                                <div className="blue-bar"></div>
                                                <a className="list-item-text" href={`#heading22`}>Needing a solution</a>
                                            </li>
                                            <li className="list-item">
                                                <div className="blue-bar"></div>
                                                <a className="list-item-text" href={`#heading23`}>Simple data form</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <section className="article">
                            ...
                            <div className="article__content">
                                ...
                                <h2 id="heading29">Heading 2 Lorem Ipsum has been the industry's standard dummy the 1500s</h2>
